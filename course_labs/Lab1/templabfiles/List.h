...
void List<T>::insertStart(T value){
    ...
    newHead->value = value;                  // Giving our new node the value
...
void List<T>::insertEnd(T value){
    ...
    newEnd->value = value;                      // Setting the value for our node

        while(temp->next != NULL){           // Until the end of the list
            temp = temp->next;
        }

    temp->next = newEnd;                        // Placing new node at end
    newEnd->next = nullptr;
...
void List<T>::insertAt(T value, int j){
    ...
    Node<T> *newMid = new Node<T>(value);                // New node that will be inserted
    newMid->value = value;
    ...
    newMid->next = current;                              // set node at jth position
    previous->next = newMid;                             // set the previous nodes next
                                                         // pointer equal to new node
...
void List<T>::removeStart(){
    ...
    Node<T> *temp = start;          // New node temp to store start

    delete start;                   // Remove start
    start = temp->next;             // Assign new start to temp->next
}
//-----------------------------------------------------------------------------
...
//                                                                            |
// Parameters: This function takes in a template "key" paramete               |
//                                                                            |
